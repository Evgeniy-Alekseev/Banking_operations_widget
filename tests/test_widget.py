...
@pytest.mark.parametrize(
    "date_str, expected",
    [("2024-03-11", "11.03.2024"), ("2024-03-11T12:30:45", "11.03.2024"), ("2024-03-11 12:30:45", "11.03.2024")],
)
...
# Проверка обработки некорректных входных данных
@pytest.mark.parametrize(
    "invalid_date", ["", "2024/03/11", "11-03-2024", "T12:30:45", "invalid date string", "2024-03"]
)
